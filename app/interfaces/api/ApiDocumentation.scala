...
import interfaces.api.endpoints.{ArticleEndpoints, FileEndpoints, RoleEndpoints, UserEndpoints}
...
class ApiDocumentation {
  ...
  val endpoints =
    UserEndpoints.endpoints ++ RoleEndpoints.endpoints ++ FileEndpoints.endpoints ++ ArticleEndpoints.endpoints
