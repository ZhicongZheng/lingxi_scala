...
class CommentController @Inject() (
  ...
  def listCommentAdmin(page: Int, size: Int) = authenticationAction andThen authenticationAction async {
  ...
  private[this] def listComments(pageQuery: CommentPageQuery) =
